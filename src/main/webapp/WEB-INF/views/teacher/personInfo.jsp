...
<div class="layui-body">
    ...
    <!-- 内容主体区域 -->
    <div class="content">
        <form id="updateForm" action="${ctx}/teacher/update" class="layui-form myForm">
            <div class="layui-form-item">
                <div class="layui-inline">
                    <label class="layui-form-label"><span class="tip">*</span>姓名：</label>
                    <div class="layui-input-inline">
                        <input class="layui-input" name="id" value="${teacher.id}" type="hidden">
                        <input class="layui-input" name="name" placeholder="姓名" value="${teacher.name}">
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <c:forEach items="${sexEnum}" var="sex" varStatus="i">
                        <input type="radio" name="sex" value="${sex.getCode()}" title="${sex.getLabel()}" <c:if test="${sex.getCode()==teacher.sex.getCode()}"> checked=""</c:if>>
                    </c:forEach>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="birthday" class="layui-input" id="birthday" placeholder="yyyy-MM-dd" value="${teacher.birthday}">
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
